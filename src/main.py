...
def main():
    ...
    for _ in range(N):
        ...
        for i in range(7):
            ...
            response_adjective_word, response_adjective_lang, response_adjective_ipa = ipa_converter.execute_v2(word=request_adjective_word_translated, lang=request_target_adjective_lang, pos="JJ")
            ...
            response_noun_word, response_noun_lang, reponse_noun_ipa = ipa_converter.execute_v2(word=request_noun_word_translated,lang=request_target_noun_lang, pos="NN")
            ...
            tmp.append(response_adjective_ipa)
