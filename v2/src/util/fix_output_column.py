...
def main():
  ...
  tmp_word_lang = df["pair_word_lang"] ## 実質 word_ipa
  tmp_word_ipa = df["pair_word_ipa"] ## 実質 word_ipa_rhyme
  tmp_word_ipa_rhyme = df["pair_word_ipa_rhyme"] ## 実質 lang

  df["pair_word_lang"] = tmp_word_ipa_rhyme
  df["pair_word_ipa"] = tmp_word_lang
  df["pair_word_ipa_rhyme"] = tmp_word_ipa
