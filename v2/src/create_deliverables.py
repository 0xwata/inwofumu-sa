        ...
        for unique_type in unique_type_group:
            for unique_syllable in unique_syllable_group:
                for unique_ipa_rhyme in unique_ipa_rhyme_group:
                    ...
                    tmp_word = tmp[["word", "word_lang", "word_en", "word_ja"]]
                    tmp_pair_word = tmp[["pair_word", "pair_word_lang", "pair_word_en", "pair_word_ja"]]
                    tmp_pair_word.columns = ["word", "word_lang", "word_en", "word_ja"]
